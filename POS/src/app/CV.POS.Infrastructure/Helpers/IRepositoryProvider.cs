...
namespace CV.POS.Infrastructure.Helpers
{
    ...
    public interface IRepositoryProvider
    {
        ...
        /// </summary>
        PosDbContext DbContext { get; set; }

        /// <summary>
        /// Get an <see cref="IBaseRepository{T}"/> for entity type, T.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// </remarks>
        T GetRepository<T>(Func<PosDbContext, object> factory = null) where T : class;
