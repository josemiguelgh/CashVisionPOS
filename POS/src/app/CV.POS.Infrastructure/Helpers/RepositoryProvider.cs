...
{
    /// <summary>
    /// Provides an <see cref="IBaseRepository{T}"/> for a client request.
    /// </summary>
    /// <remarks>
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        /// Get or create-and-cache the default <see cref="IBaseRepository{T}"/> for an entity of type T.
        /// </summary>
        /// <typeparam name="T">
        /// Root entity type of the <see cref="IBaseRepository{T}"/>.
        /// </typeparam>
        /// <remarks>
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<PosDbContext, object> factory = null) where T : class
        {
